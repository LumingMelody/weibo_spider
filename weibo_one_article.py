...
for index, url in enumerate(urls):
    ...
    if "mweibo.com" not in url:
        ...
        # ws.append([url, forward_count, comment_count, like_count, video, play_count, level])
        # wb.save("单文章采集.xlsx")
    # else:
    #     mweibo_cn_url = url
    headers = {
    ...
    ws.append(
        [url, article_reposts_count, article_comments_count, article_attitudes_count, round(all_interact_count / 15, 2),
         video, play_count, level, article_post_format_time, user_name])
    wb.save("单文章采集_08_03.xlsx")
print("=" * 100)
